 ...
 */
public class WriteCFSRFIDTag extends BasicActivity {
    ...
    private EditText cfsrfidMaterial;
...
//            break;
    ...
    public void onWriteBlock(View view) {
        ...
        //    return;
        //}
        String data = cfsrfidDateY.getText().toString()+cfsrfidDateM.getText().toString()+cfsrfidDateD.getText().toString()+cfsrfidSupplier.getText().toString()+cfsrfidMaterial.getText().toString()+cfsrfidColor.getText().toString()+cfsrfidNumber.getText().toString()+cfsrfidReserve;
        Log.d("CFSRFID", "onWriteBlock.rawdata: " + data);
        data = toHex(data);
        Log.d("CFSRFID", "onWriteBlock.hexdata: " + data);
        String data1 = data.substring(0,15);
        String data2 = data.substring(16,31);
        String data3 = data.substring(32,47);
    ...
    private void writeBlock(){
        String dataall = cfsrfidDateY.getText().toString()+cfsrfidDateM.getText().toString()+cfsrfidDateD.getText().toString()+cfsrfidSupplier.getText().toString()+cfsrfidMaterial.getText().toString()+cfsrfidColor.getText().toString()+cfsrfidNumber.getText().toString()+cfsrfidReserve;
        dataall = toHex(dataall);
        String data1 = dataall.substring(0,15);
        String data2 = dataall.substring(16,31);
        String data3 = dataall.substring(32,47);
        Log.d("CFSRDIF", "writeBlock.data1: " + data1);
        Log.d("CFSRDIF", "writeBlock.data1: " + data2);
        Log.d("CFSRDIF", "writeBlock.data1: " + data3);
